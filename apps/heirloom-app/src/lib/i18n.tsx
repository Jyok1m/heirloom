...
const translations = {
  en: {
    ...
    deceased: 'Deceased',
    religionL: 'Religion',
    firstNamesL: 'Given names',
    usualNameL: 'Usual first name',
    birthNameL: 'Family name',
    usedNameL: 'Name in use',
  ...
  fr: {
    ...
    religionL: 'Religion',
    firstNamesL: 'Prénoms',
    usualNameL: 'Prénom usuel',
    birthNameL: 'Nom de famille',
    usedNameL: 'Nom d’usage',
