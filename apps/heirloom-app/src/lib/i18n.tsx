...
const translations = {
  en: {
    ...
    editTree: 'Edit tree',
    treeIconLabel: 'Icon',
    treeColorLabel: 'Color',
    createAction: 'Create',
    cancel: 'Cancel',
    // Type-to-confirm (explicit confirmation for irreversible actions)
    typeToConfirm: 'To confirm, type',
    typeToConfirmBelow: 'below:',
    typeMismatch: 'The text does not match.',
    deleteWord: 'delete',
    regenerateWord: 'regenerate',
    // Sharing & invitations
    ...
    deceased: 'Deceased',
    religionL: 'Religion',
    firstNamesL: 'Given names (comma-separated)',
    familyNameL: 'Family name',
    maidenNameL: 'Birth name',
    moreInfo: 'Add more info',
    relFather: 'Father',
    relMother: 'Mother',
    relBrother: 'Brother',
    relSister: 'Sister',
    relHusband: 'Husband',
    relWife: 'Wife',
    relPartnerM: 'Partner (m)',
    relPartnerF: 'Partner (f)',
    relSon: 'Son',
    ...
    fanView: 'Fan',
    back: 'Back',
    fewerLevels: 'Fewer generations',
    moreLevels: 'More generations',
    dateL: 'Date',
  ...
  fr: {
    ...
    editTree: 'Modifier l’arbre',
    treeIconLabel: 'Icône',
    treeColorLabel: 'Couleur',
    createAction: 'Créer',
    cancel: 'Annuler',
    // Confirmation par saisie (actions irréversibles)
    typeToConfirm: 'Pour confirmer, tapez',
    typeToConfirmBelow: 'ci-dessous :',
    typeMismatch: 'Le texte ne correspond pas.',
    deleteWord: 'supprimer',
    regenerateWord: 'régénérer',
    // Partage & invitations
    ...
    deceased: 'Décédé·e',
    religionL: 'Religion',
    firstNamesL: 'Prénoms (séparés par des virgules)',
    familyNameL: 'Nom de famille',
    maidenNameL: 'Nom de naissance',
    moreInfo: 'Ajouter plus d’infos',
    relFather: 'Père',
    relMother: 'Mère',
    relBrother: 'Frère',
    relSister: 'Sœur',
    relHusband: 'Mari',
    relWife: 'Femme',
    relPartnerM: 'Conjoint',
    relPartnerF: 'Conjointe',
    relSon: 'Fils',
    relDaughter: 'Fille',
    relExM: 'Ex-conjoint',
    relExF: 'Ex-conjointe',
    ...
    fanView: 'Éventail',
    back: 'Retour',
    fewerLevels: 'Moins de générations',
    moreLevels: 'Plus de générations',
    dateL: 'Date',
