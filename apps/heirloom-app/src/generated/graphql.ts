...
export type CreatePersonInput = {
  ...
  usedName?: string | null | undefined;
  usualName?: string | null | undefined;
};
...
export type TreeCanvasQuery = { tree: { id: string, name: string, persons: Array<{ id: string, firstName: string | null, usualName: string | null, lastName: string | null, usedName: string | null, sex: Sex, religion: Religion, photoMediaId: string | null, birthDate: string | null, deceased: boolean }>, unions: Array<{ id: string, partners: Array<{ id: string }>, children: Array<{ person: { id: string } }> }> } };
...
export type PersonDetailQuery = { person: { id: string, treeId: string, firstName: string | null, usualName: string | null, lastName: string | null, usedName: string | null, namePrefix: string | null, nameSuffix: string | null, nickname: string | null, sex: Sex, religion: Religion, notes: string | null, photoMediaId: string | null, events: Array<{ id: string, type: EventType, description: string | null, dateValue: string | null, dateSort: unknown, place: string | null, notes: string | null, citations: Array<{ id: string, page: string | null, quality: number | null, source: { id: string, title: string } }> }>, media: Array<{ id: string, type: MediaType, filePath: string, mimeType: string, title: string | null, links: Array<{ id: string, personId: string | null }> }>, unions: Array<{ id: string, type: UnionType, notes: string | null, partners: Array<{ id: string, firstName: string | null, lastName: string | null }>, children: Array<{ personId: string, pedigree: Pedigree, person: { id: string, firstName: string | null, lastName: string | null } }> }>, parentUnions: Array<{ id: string, partners: Array<{ id: string, firstName: string | null, lastName: string | null }> }> } };
